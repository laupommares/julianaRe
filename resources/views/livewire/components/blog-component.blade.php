<div class="h-[810px] bg-blue flex items-center justify-center">
    <div @class([
        'bg-white',
        'h-[778px] w-[calc(100%-32px)]' => $type === 'short',
        'h-full w-[calc(100%-80px)]' => $type === 'long',
        ])>
        <div class="mx-auto px-4 sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1140px] 2xl:max-w-[1320px] flex items-center justify-center">
            <div class="bg-white h-[746px] w-full relative top-8 flex flex-col text-dark">
                <div class="w-full flex justify-center my-8">
                    <h1 @class([
                        'font-serif text-4xl',  
                        'text-blue-500' => $type === 'short',  
                        'mt-16' => $type === 'long'     
                    ])>Consejos y bienestar</h1>
                </div>
                <div @class([
                    'flex gap-8',
                    'flex-basis' => $type === 'short',
                    'flex-col' => $type === 'long'
                    ])>
                    @if($type === 'short') {{-- Esto tiene que salir de long en realidad, con esa misma info mostrar en el --}} 
                        <div class="flex flex-col">
                            ...
                            <div class="flex justify-center items-center space-x-4">
                                <button class="px-4 py-2 text-black disabled:opacity-50">
                    ...
                    <div class="flex flex-col gap-8">
                        ...
                        'text-base' => $type === 'short',
                        'text-xl text-center' => $type === 'long'])>En esta sección, comparto artículos, consejos y recursos sobre nutrición y bienestar que considero fundamentales para ayudarte a lograr un estilo de vida más saludable y equilibrado. 
