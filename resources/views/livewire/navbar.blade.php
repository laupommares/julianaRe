                ...
                <div class="bg-white rounded-lg p-6 w-1/3">
                    ...
                    <form>
                        <div class="mb-4">
                            ...
                            <input type="email" id="login-email" class="border rounded w-full px-3 py-2 text-dark-gray border-blue bg-white placeholder:text-sm placeholder:text-dark-gray/70"   placeholder="Ingresá tu correo electrónico" required>
                        </div>
                        <div class="mb-4">
                            <label for="login-password" class="block text-dark-gray">Contraseña</label>
                            <input type="password" id="login-password" class="border rounded w-full px-3 py-2 text-dark-gray border-blue bg-white placeholder:text-sm placeholder:text-dark-gray/70" placeholder="Ingresá tu contraseña" required>
                        </div>
