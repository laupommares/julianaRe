<div class="container py-16 {{ $type === 'long' ? 'h-full' : 'h-fit' }}">
    <div class="flex {{ $type === 'long' ? 'flex-wrap' : '' }} gap-8">
        <div class=" text-dark flex flex-col gap-8">
            ...
            @else 
                <div class="relative">
                    <img class="w-[300px] md:w-[426px] rounded-md {{ $type === 'long' ? 'float-right ml-8 mb-8' : '' }}" src="{{ asset('juli-about.jpg') }}" alt="">
                    ...
                    <p class="text-base font-light">
                        ...
                        <br><br>
                        <strong class="font-bold leading-10">Mi historia: más allá de la nutrición</strong> <br>
                        ...
                        <br><br>
                        <strong class="font-bold leading-10">Mi enfoque: nutrición, hábitos y emociones</strong><br>
