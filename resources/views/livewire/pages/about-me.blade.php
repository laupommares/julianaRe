    ...
    <section class="bg-white py-20">
        <div class="container flex flex-col-reverse md:flex-row items-center gap-8">
            ...
            <div class="md:w-2/3 text-dark font-serif leading-relaxed">
                <h2 class="text-orange text-2xl font-slab mb-6">✨ Bienvenid@ a este espacio</h2>
                <h1 class="text-4xl font-serif font-bold mb-6">Soy Juliana, <br> nutricionista y coach ontológica</h1>
                ...
                <p class="mb-4 leading-6">
                    ...
                    <br> <br>
                    <span class="italic"> Gracias por estar acá. Ojalá este espacio te sume, te abrace y te inspire a
                        reconectar con lo que
                        realmente te hace bien.</span>
                </p>
            ...
            <!-- Imagen -->
            <div class="md:w-1/2">
                <img src="{{ asset('juli-about.jpg') }}" alt="Juliana"
                    class="rounded-xl shadow-md w-full max-w-sm mx-auto object-cover">
            </div>
        </div>
    </section>
